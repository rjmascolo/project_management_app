...
class UserProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_project" do
    assert_difference('UserProject.count') do
      post user_projects_url, params: { user_project: { project_id: @user_project.project_id, type: @user_project.type, user_id: @user_project.user_id } }, as: :json
    end
  ...
  test "should update user_project" do
    patch user_project_url(@user_project), params: { user_project: { project_id: @user_project.project_id, type: @user_project.type, user_id: @user_project.user_id } }, as: :json
    assert_response 200
  end
